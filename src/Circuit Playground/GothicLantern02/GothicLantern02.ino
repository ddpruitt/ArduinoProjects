...
#define NUMBER_OF_FLAMES 10 // depends on number of neopixel triplets. 5 for 16 NeoPixel ring. 4 for 12 NeoPixel ring
...
//  }
  ...
  CircuitPlayground.clearPixels(); // Initialize all pixels to 'off'
...
// 
  ...
  for(byte sub_pixel=0; sub_pixel<FLAME_WIDTH; sub_pixel++) {
    ...
    CircuitPlayground.setPixelColor(flame_num * FLAME_WIDTH + sub_pixel, scaleD_rgb[0],scaleD_rgb[1], scaleD_rgb[2]);
    //CircuitPlayground.setBrightness(new_brightness * 10);
  }
